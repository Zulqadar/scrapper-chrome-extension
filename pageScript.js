window.onload = function() {
    console.log('I am from another planet.');
}
...
function initZullColorPicker() {
    // var parentDiv = document.createElement("div");
    // parentDiv.setAttribute("id", "zullBoxParent");
    // parentDiv.style.position = "absolute";
    // parentDiv.style.opacity = "1";
    // parentDiv.style.border = "none";
    // parentDiv.style.backgroundColor = "none";
    // parentDiv.style.width = "1366px";
    // parentDiv.style.height = "698px";
    // parentDiv.style.cursor = "default";
    // parentDiv.style.zIndex = "5000";

    var div = document.createElement("div");
    div.style.width = "20px";
    div.style.height = "20px";
    div.style.border = "1px solid red";
    div.setAttribute("id", "zullColorBox");
    ...
    if (document.getElementById("zullColorBox") == null) {
...
function HandleMouseClick(event) {
    ...
    var colorRGBA = screenshotCtx.getImageData(x, y, 1, 1).data;
    var b = "rgba(" + colorRGBA[0] + "," + colorRGBA[1] + "," + colorRGBA[2] + "," + colorRGBA[3] + ")";
    document.getElementById('zullColorBox').style.backgroundColor = b;
    RemoveMouseMove();
    RemoveMouseClick();
    document.getElementById('zullColorBox').style.display = "none";
    console.log('You Picked This Color : ' + colorRGBA)
    alert('You Picked This Color : ' + colorRGBA)
}
...
function HandleMouseMove(e) {
    ...
    var b = "rgba(" + colorRGBA[0] + "," + colorRGBA[1] + "," + colorRGBA[2] + "," + colorRGBA[3] + ")";
    document.getElementById('zullColorBox').style.backgroundColor = b;
    document.getElementById('zullColorBox').style.display = "block";
    document.getElementById('zullColorBox').style.top = (y + 20) + "px";
    document.getElementById('zullColorBox').style.left = (x + 20) + "px";
}
